...
//		System.out.println(st3.getName()); // 김명진
		...
		Student std1 = new Student.Builder("장지민", 30).build();
		
		Student std2 = new Student.Builder("이지윤", 30)
				.grade("2학년")
				.major("귀금속보석디자인학과")
				.build();
		
		Student std3 = new Student.Builder("이미진", 16)
				.grade("3학년")
				.build();
		
		Student std4 = new Student.Builder("이지우", 19)
				.major("심리학과")
				.build();
